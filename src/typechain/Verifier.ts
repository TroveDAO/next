...
export interface VerifierInterface extends utils.Interface {
  functions: {
    "isValidData(uint256,uint256,uint256,bytes,string,uint256,uint256,string,uint256,uint256,address)": FunctionFragment;
...
export interface Verifier extends BaseContract {
  ...
  functions: {
    isValidData(
      ...
      sig: BytesLike,
      lazyMintURI: string,
      fromVaultId: BigNumberish,
      fromVaultQuantity: BigNumberish,
      treasureType: string,
